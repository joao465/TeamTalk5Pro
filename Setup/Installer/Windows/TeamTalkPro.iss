...
AppName=TeamTalk Pro
AppVersion={#ProVersion}
VersionInfoVersion={#ProVersion}.0
AppVerName=TeamTalk Pro {#ProVersion}
AppPublisher=TeamTalk Pro
DefaultDirName={autopf}\TeamTalk Pro
DefaultGroupName=TeamTalk Pro
UninstallDisplayName=TeamTalk Pro {#ProVersion}
...
[CustomMessages]
en.ImportOfficialConfig=Official TeamTalk settings were found at "%1". Do you want to import them into TeamTalk Pro? The official TeamTalk installation and settings will not be changed.
pt_BR.ImportOfficialConfig=Foram encontradas configurações do TeamTalk oficial em "%1". Deseja importar essas configurações para o TeamTalk Pro? A instalação e as configurações do TeamTalk oficial não serão alteradas.
en.ImportFailed=TeamTalk Pro was installed, but the official TeamTalk settings could not be imported.
pt_BR.ImportFailed=O TeamTalk Pro foi instalado, mas não foi possível importar as configurações do TeamTalk oficial.
...
[Icons]
Name: "{group}\TeamTalk Pro"; Filename: "{app}\TeamTalk5.exe"; WorkingDir: "{app}"
Name: "{group}\TeamTalk Pro - Áudio Pro"; Filename: "{app}\TeamTalk5.exe"; Parameters: "--pro-audio-settings"; WorkingDir: "{app}"
Name: "{autodesktop}\TeamTalk Pro"; Filename: "{app}\TeamTalk5.exe"; WorkingDir: "{app}"; Tasks: desktopicon
...
Filename: "{app}\TeamTalk5.exe"; Description: "{cm:LaunchProgram,TeamTalk Pro}"; WorkingDir: "{app}"; Flags: postinstall nowait skipifsilent
